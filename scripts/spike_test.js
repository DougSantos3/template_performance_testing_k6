...
export default function () {
    ...
    const randomParamData = paramsData[Math.floor(Math.random() * paramsData.length)]
    const randomEmailData = emailsData[Math.floor(Math.random() * emailsData.length)]
    ...
    let resDelete = http.del(`${BASE_URL}/endpoint/${param}`, JSON.stringify({ email: email }), {
